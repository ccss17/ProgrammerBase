...
3. 어떤 형식문으로부터 다른 형식문이 연역되는지 정하는 **연역 규칙** 만들기 : 기초 명제 논리학의 연역 규칙은 **대입규칙**과 **분리규칙**으로 구성됩니다.
...
그런데 ![](https://math.now.sh/?from=G) 와 ![](https://math.now.sh/?from=\sim{}G) 가 둘 다 **PM 에 의하여** 증명될 수 없으므로 둘 중 무엇이 올바른지 알 수 없을 것만 같습니다. 하지만 이것을 밝히는 일은 생각보다 매우 간단하며 다음과 같이 **상위 수학에 의하여** 증명될 수 있습니다.
